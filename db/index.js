...
async function initDB() {
  if (!process.env.DATABASE_URL) {
    console.warn('⚠️  Skipping DB init — no DATABASE_URL')
    return
  }
  try {
    await pool.query(`
    ...
    console.error('⚠️  DB init error (non-fatal):', e.message)
  }
}

const PLAN_LIMITS = { free: 3, solo: 50, team: 200, enterprise: 500 }
const SEAT_LIMITS = { free: 1, solo: 1, team: 4, enterprise: 10 }
const OVERAGE_PRICE_DOC = 5.00
const OVERAGE_PRICE_RESEARCH = 50.00
